...
Faça a verificação de diagnóstico residual de seu modelo ARIMA. Os resíduos
são ruído branco?
...
```
Como pode ser observado, os residos apresentam caracteristicas de ruido branco.

### Questão 5

Use o modelo SARIMA de sua escolha para fazer previsões h (livre escolha)
passos à frente.

Realizando predição de 24 peridodos(2 anos) com o modelo otimizado.
