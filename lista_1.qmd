...
Como o p-valor é maior do que 0,05, não rejeitamos a hipótese nula $$H_0$$ indicando que a série temporal tem uma raiz unitária e, portanto, não é estacionária. Após este teste e observando os resultados da ACF e dos gráficos da série, chegamos à conclusão de que a série não é estacionária e possui uma tendência estocástica.
